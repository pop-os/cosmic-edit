...
stage = آماده‌سازی
staged-changes = تغییرات آماده‌شده
unstage = لغو آماده‌سازی
...
open-recent-file = باز کردن پرونده‌های اخیر
close-file = بستن پرونده
menu-open-project = باز کردن پروژه...
open-recent-project = باز کردن پروژه‌های اخیر
...
menu-keyboard-shortcuts = میانبرهای صفحه‌کلید...
